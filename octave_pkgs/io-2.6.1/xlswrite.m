...
## If a valueof true (logical) or 1 (numerical) is specified xlswrite
...
## specified.  If @var{verbose} is omitted or a value of false or 0 (zero)
## is specified (the default) no interface info is shown.
## @end item
## @end table
##

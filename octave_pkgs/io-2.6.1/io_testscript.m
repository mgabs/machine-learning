...
## filename "io-test.xls" (for Excel files) or "io-test.ods" is chosen by
...
function rslts = io_testscript (intf, fname="io-test.xls", intf2=[])
  ...
  try
    ...
    printf (" 2. Insert first empty sheet...\n");
    ...
    printf (" 3. Add data to test sheet...\n");
    xlswrite (fname, arr1, "Testsheet", "b2:d3", intf2);
    if (isuno)
      pause (dly);
    endif
    ...
    printf (" 4. Add another sheet with just one number in A1...\n");
    ...
    err = 0;
    printf (" 7. Tests part 1 (basic I/O):\n");
    try
    ...
    printf (" 8. Repeat reading, now return formulas as text...\n");
    ...
    printf (" 9. Tests part 2 (read back formula):\n");
